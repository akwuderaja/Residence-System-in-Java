...
public class ResidenceSystemA5Q3 {
    ...
    public ResidenceSystemA5Q3() {
        ...
        dialogIO.outputString("-------Getting Residence information-------");
        String name = dialogIO.readString("Enter the name of the Residence: ");
        int firstBedNum = dialogIO.readInt("Enter the integer label of the first bed: ");

        int lastBedNum = dialogIO.readInt("Enter the integer label of the last bed: ");
    ...
    public void addStudent() {
        dialogIO.outputString("-------Adding Student to Residence-------");
        String name = dialogIO.readString("Enter the name of the student: ");

        String sSIN = dialogIO.readString("Enter the social insurance number of the student: ");

        String sNSID = dialogIO.readString("Enter the NSID of the student: ");
    ...
    public void addManager() {
        dialogIO.outputString("-------Adding Manager to Residence-------");
        String mName = dialogIO.readString("Enter the manager's name: ");
        String mSIN = dialogIO.readString("Enter the manager's SIN: ");
        String mEN = dialogIO.readString("Enter the manager's employee number: ");
        ...
        String response = dialogIO.readString("Is the manager a consultant? (yes or no): ");
    ...
    public void assignManagerToStudent() {
        dialogIO.outputString("-------Assigning a new Manager-Student Association-------");
        String sNSID = dialogIO.readString("Enter the NSID of the student: ");
        ...
        String mEN = dialogIO.readString("Enter the employee number of the manager: ");
    ...
    public void assignBed() {
        dialogIO.outputString("-------Assigning a Student to a Bed-------");
        String sNSID = dialogIO.readString("Enter the NSID of the student: ");
        ...
        int bedNum = dialogIO.readInt("Enter the bed number for the student: ");
        dialogIO.outputString("");  // discard the remainder of the line
    ...
    public void dropAssociation() {
        dialogIO.outputString("-------Dropping a new Manager-Student Association-------");
        String sNSID = dialogIO.readString("Enter the NSID of the student: ");
    ...
    public void releaseStudent() {
        // TODO: implement stub
        String NSID =  dialogIO.readString("Enter Student's NSID:");
        if (NSID == ""){
            dialogIO.outputString("The NSID is required!");
        }else{
            Student student = students.get(NSID);
            if(student==null){
                dialogIO.outputString("The NSID is not valid!");
            }else{
                residence.freeBed(student.getBedLabel());
                dialogIO.outputString("The selected student has been removed from his/her bed!");
            }
        }
    ...
    public static void main(String[] args) {
        ...
        dialogIO.outputString("-------Initializing the system-------");
        ...
        dialogIO.outputString("-------Running the system-------");
        while (task != 1) {
            try {
                dialogIO.outputString("Options:"
                        + "\n\t1: Quit"
                        + "\n\t2: Add a new student"
                        + "\n\t3: Add a new manager"
                ...
                else dialogIO.outputString("Invalid option, try again.");
            } catch (RuntimeException e) {
