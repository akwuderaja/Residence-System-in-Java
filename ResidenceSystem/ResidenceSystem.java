...
public class ResidenceSystem {
    ...
    public void releaseStudent() {
        // TODO: implement stub
        System.out.println("Enter Student's NSID:");
        String NSID =  consoleIn.next();
        if (NSID == ""){
            System.out.println("The NSID is required!");
        }else{
            Student student = students.get(NSID);
            if(student==null){
                System.out.println("The NSID is not valid!");
            }else{
                residence.freeBed(student.getBedLabel());
                System.out.println("The selected student has been removed from his/her bed!");
            }
        }
